...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Φόρμα αίτησης</li>
    ...
    <section class="container" >
        ...
        if(isset($_SESSION['u_uid'])){ ?> 
          <form class="form-horizontal " style="background-color: lightgrey; padding: 20px;
                            text-align: center; " action="request_progress_ret-inc.php" method="POST" >
     <div id="legend">
          <h3 class="font-weight-bold" style="margin-bottom:30px" >Στοιχεία ασφαλισμένου για προβολή εξέλιξης αιτήματος συνταξιοδότησης</h3>
       </div>
