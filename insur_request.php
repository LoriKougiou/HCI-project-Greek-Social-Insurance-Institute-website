...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Αίτηση αφάλισης εξαρτώμενου μέλους</li>
</ol>
    ...
    <section class="container" >
        ...
        if(isset($_SESSION['u_uid'])){ ?> 
          <form class="form-horizontal " style="background-color: lightgrey; padding: 20px;
                            text-align: center; " action="insur_request-inc.php" method="POST" >
     <div id="legend">
          <h3 class="font-weight-bold" style="margin-bottom:30px" >Στοιχεία ασφαλισμένου για αίτηση ασφάλισης εξαρτώμενου μέλους</h3>
       </div>
      ...
      <hr style=" border-width: 2px;"/>
         ...
         <div id="legend">
          <h3 class="font-weight-bold" style="margin-bottom:30px" >Στοιχεία ατόμου που θέλετε να ασφαλίσετε.</h3>
       </div>

       <p class="help-block">Παρακαλώ συμπληρώστε τα παρακάτω στοιχεία με λατινικούς χαρακτήρες</p>

        <div class="control-group">
                <label class="control-label" for="ins_first"><strong>Όνομα</strong></label>
                <label class="label"   style="text-align: right; font-size:80%; color:red ">*</label>
                <div class="controls">
                    <input type="text" name="ins_first" placeholder="" id="ins_first" value=""  class="input" style=" height: 5%; margin:0 auto;">      
                </div>
            </div>

         <div class="control-group">
                <label class="control-label" for="ins_last"><strong>Επίθετο</strong></label>
                <label class="label"   style="text-align: right; font-size:80%; color:red ">*</label>
                <div class="controls">
                    <input type="text" name="ins_last" placeholder="" id="ins_last" value=""  class="input" style=" height: 5%; margin:0 auto;">
                    
                </div>
            </div>

           <div class="control-group">
                <label class="control-label" for="ins_amka"><strong>Ά.Μ.Κ.Α.</strong></label>
                <label class="label"   style="text-align: right; font-size:80%; color:red ">*</label>
                <div class="controls">
                    <input type="text" name="ins_amka" placeholder="" id="ins_last" value=""  class="input" style=" height: 5%; margin:0 auto;">
