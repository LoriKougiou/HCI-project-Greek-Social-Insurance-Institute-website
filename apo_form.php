...
<div class="container-fluid">
    ...
    <?php        //an  exei pragmatopoihthei login apo kapoio xristi pernw ta stoixeia tou xrhsth
        if(isset($_SESSION['u_uid'])){ ?> 
		 ...
		 <div id="legend">
      		<h3 class="font-weight-bold" style="margin-bottom:30px" >Στοιχεία ασφαλισμένου για έκδοση βεβαίωσης αποδοχών</h3>
   		 </div>
        ...
        <button type="submit" name="ekdosi_apo" class="btn btn-secondary " >Έκδοση Βεβαίωσης</button>
