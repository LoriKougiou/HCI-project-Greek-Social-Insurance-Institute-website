...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="vevaiwsh.php">Βεβαιώσεις</a></li>
  <li class="breadcrumb-item active">Συνταξιούχος</li>
</ol>
    ...
    <?php        //an  exei pragmatopoihthei login apo kapoio xristi pernw ta stoixeia tou xrhsth
        if(isset($_SESSION['u_uid'])){ ?> 
          <form class="form-horizontal " style="background-color: lightgrey; padding: 20px;
                            text-align: center; " action="vevaiwsh-inc.php" method="POST" >
		 <div id="legend">
      		<h3 class="font-weight-bold" style="margin-bottom:30px" >Στοιχεία ασφαλισμένου για έκδοση βεβαίωσης σύνταξης</h3>
   		 </div>
        ...
        <button type="submit" name="ekdosi_synt" class="btn btn-secondary " >Έκδοση Βεβαίωσης</button>
